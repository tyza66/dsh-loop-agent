...
window.__ModuleLoader__.load({ id: '@tyza66/dsh-loop-agent', factory: (require) => {
  ...
  var en = {
    ...
    foreverHint: 'Type /forever in any halted conversation to re-arm its loop (only works when the global switch is on).'
  }
  ...
  var zh = {
    ...
    versionLabel: '版本',
    foreverHint: '在任何已停止的会话中输入 /forever 即可重新启动该会话的 loop（仅在全局开关打开时生效）。'
  }
