...
function apply(ctx, config) {
  ...
  const store = {
    ...
    /** How many agents currently have a live, running driver task. Halted
     * and parked states (stopped by the user, archived) stay in the map so
     * the supervisor does not reattach them — but they are not "running",
